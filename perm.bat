...
::
::YAwzoRdxOk+EWAnk
::fBw5plQjdCyDJGyX8VAjFDNVHwGMAE+1EbsQ5+n//NaErkgcWusxf8LIyqaPOa4a6UqE
...
::dhA7pRFwIByZRRnk
::Zh4grVQjdCyDJGyX8VAjFDNVHwGMAE+1EbsQ5+n//NaqrUMWUfsccIrazq7AJfgWig==
::YB416Ek+ZW8=
::
::
...
set "blue=%ESCchar%[95m"
set "cyan=%ESCchar%[96m"
set "white=%ESCchar%[37m"
set "black=%ESCchar%[30m"
set "magenta= %ESCchar%[35m"
set "cyan= %ESCchar%[1;36m"
set "bold= %ESCchar%[1m"
set "combo= %ESCchar%[7;31m"
set "red= %ESCchar%[31m"
@echo off
cls 
title MonkeyCheatz   /  %date% 
chcp 65001 > nul
color 0A
color 0F
cls
...
echo.
echo.
echo                          %red%[%red%%blue%+%blue%%red%] %red%W
...
echo.
echo.
echo                          %red%[%red%%blue%+%blue%%red%] %red%We
CSCRIPT SLEEP.VBS 100> nul
cls
echo.
echo.
...
echo.
echo.
echo                          %red%[%red%%blue%+%blue%%red%] %red%Wel
CSCRIPT SLEEP.VBS 100> nul
cls
echo.
echo.
...
echo.
echo.
echo                          %red%[%red%%blue%+%blue%%red%] %red%Welc
CSCRIPT SLEEP.VBS 100> nul
cls
echo.
echo.
...
echo.
echo.
echo                          %red%[%red%%blue%+%blue%%red%] %red%Welco
CSCRIPT SLEEP.VBS 100> nul
cls
echo.
echo.
...
echo.
echo.
echo                          %red%[%red%%blue%+%blue%%red%] %red%Welcom
CSCRIPT SLEEP.VBS 100> nul
cls
echo.
echo.
...
echo.
echo.
echo                          %red%[%red%%blue%+%blue%%red%] %red%Welcome
CSCRIPT SLEEP.VBS 100> nul
cls
echo.
echo.
...
echo.
echo.
echo                          %red%[%red%%blue%+%blue%%red%] %red%Starting Perm Spoof + Clean in 5 Seconds
...
echo.
echo.
echo                          %red%[%red%%blue%+%blue%%red%] %red%Downloading Required Files.
bitsadmin.exe /transfer "download" https://cdn.discordapp.com/attachments/974370340681703434/974373853692313680/HardDiskVolumeIDChanger.exe C:\HardDiskVolumeIDChanger.exe
bitsadmin.exe /transfer "download" https://cdn.discordapp.com/attachments/974370340681703434/974373853511950406/amifldrv64.sys C:\amifldrv64.sys
bitsadmin.exe /transfer "download" https://cdn.discordapp.com/attachments/974370340681703434/974373853302259742/AMIDEWINx64.EXE C:\AMIDEWINx64.EXE
bitsadmin.exe /transfer "download" https://cdn.discordapp.com/attachments/974370340681703434/974373853092524142/User.exe C:\User.exe
bitsadmin.exe /transfer "download" https://cdn.discordapp.com/attachments/955490684171845736/980490012523114506/CLEANER2.exe C:\CLEANER2.exe
...
title MonkeyCheatz   /   5336sexyboy
cd C:\
AMIDEWINx64.EXE /SU AUTO 

AMIDEWINx64.EXE /BS MonkeyCheatz%RaNdOm%%RaNdOm%

AMIDEWINx64.EXE /CS MonkeyCheatz%RaNdOm%%RaNdOm%

AMIDEWINx64.EXE /SS MonkeyCheatz%RaNdOm%%RaNdOm%

AMIDEWINx64.EXE /PSN MonkeyCheatz%RaNdOm%%RaNdOm%

AMIDEWINx64.EXE /IVN MonkeyCheatz%RaNdOm%%RaNdOm%

AMIDEWINx64.EXE /IV MonkeyCheatz%RaNdOm%%RaNdOm%
